...
function invokeRenderer(renderFunc, dustChunk, dustContext, dustBodies, params, buildInput) {
    var dustGlobal = dustContext.global;
    var attributes = dustGlobal.raptorAttributes;
    if (!attributes) {
        attributes = dustContext.get('raptorAttributes');
        dustGlobal.raptorAttributes = attributes = attributes || {};
    }
    ...
    renderContext.stream = dustGlobal.stream;
