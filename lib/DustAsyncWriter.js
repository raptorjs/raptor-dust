...
function DustAsyncWriter(dustChunk, dustContext, attributes, async, parent) {
    var writer = new ChunkWriter(this);
    DustAsyncWriter.$super.call(this, writer, parent, attributes);
...
DustAsyncWriter.prototype = {
    ...
    beginAsync: function(options) {
        ...
        this._dustChunk = this._dustChunk.map(function(asyncDustChunk) {
            asyncOut = new DustAsyncWriter(asyncDustChunk, dustContext, attributes, true /* async */, parent);
        });

        //asyncOut.handleBeginAsync(options, this);
        this._tracker.begin(asyncOut, this, options);
